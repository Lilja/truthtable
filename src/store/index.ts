...
export default new Vuex.Store({
  ...
  actions: {
    ...
    exampleThree({state}) {
        state.processed = false
        state.exampleText = 'In europe there is a thing called <a href="https://en.wikipedia.org/wiki/Little_Saturday">"small saturday"</a>. Along with weekends, we need an equation to find out if we can celebrate small saturday as well as the weekend. But what expression to use?'
        state.columnNames = [
            'isSmallSaturday',
            'isWeekend'
        ]
